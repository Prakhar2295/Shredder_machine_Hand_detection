...
def drawsafelines(image_np,Orientation,Line_Perc1,Line_Perc2):
    ...
    cv2.putText(image_np,"Red Line: Safet Border LIne",
                (posii,50),cv2.FONT_HERSHEY_COMPLEX_SMALL,0.5,(255,0,0),1,cv2.LINE_AA)
    ...
    if(Orientation=="bt"):
        ...
        Line_Position1 = int(image_np.shape[1]-image_np.shape[1]*(Line_Perc2/100))

        cv2.line(img = image_np,pt1 = (Line_Position1,0), pt2 = (Line_Position1,image_np.shape[0]), color = (255,0,0), thickness = 2, lineType = 8, shift = 0)
